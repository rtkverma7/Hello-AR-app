...
## Requirements
 ...
 - If you're running on emulator, install the latest **{ARCore}_for_emulator.apk** from the **assets** tab [here](https://github.com/google-ar/arcore-android-sdk/releases).
